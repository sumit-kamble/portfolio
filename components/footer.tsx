  ...
  },
  {
    ...
    icon: (props: SVGProps<SVGSVGElement>) => (
      <svg
        ...
        className='h-6 w-6'
      >
        <path d='M23.954 4.569c-.885.392-1.833.656-2.825.775 1.014-.611 1.793-1.574 2.162-2.723-.951.563-2.005.974-3.127 1.196-.897-.957-2.178-1.556-3.594-1.556-2.719 0-4.92 2.201-4.92 4.917 0 .39.045.765.127 1.125-4.087-.205-7.713-2.165-10.141-5.144-.424.722-.667 1.561-.667 2.457 0 1.692.859 3.182 2.165 4.058-.798-.026-1.548-.245-2.205-.61v.061c0 2.363 1.678 4.333 3.91 4.785-.408.111-.84.171-1.285.171-.314 0-.617-.03-.916-.086.617 1.926 2.417 3.324 4.55 3.364-1.67 1.31-3.778 2.092-6.067 2.092-.394 0-.779-.023-1.161-.068 2.164 1.388 4.729 2.197 7.485 2.197 8.982 0 13.897-7.438 13.897-13.897 0-.211-.005-.423-.014-.633.954-.689 1.782-1.553 2.437-2.541z' />
      </svg>
    )
  }
]
